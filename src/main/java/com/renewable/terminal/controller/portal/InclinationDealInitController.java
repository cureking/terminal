...
@Controller
@RequestMapping("/inclination/deal/init/")
public class InclinationDealInitController {
	...
	public ServerResponse<PageInfo> getDataList(@RequestParam(value = "pageNum", defaultValue = "1") int pageNum,
		...
		return iInclinationDealInitService.getDataList(pageNum, pageSize, sensor_identifier);
	}
	...
	public ServerResponse<List<Object>> getDataListByTime(@RequestParam(value = "startTime", defaultValue = "1970-1-1 0:0:0") String startTime,
														  @RequestParam(value = "endTime", defaultValue = "2919-03-14 11:33:54") String endTime,
														  int sensor_identifier) {
		return iInclinationDealInitService.getDataListByTime(startTime, endTime, sensor_identifier);
	}
