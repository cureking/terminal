...
public class InclinationDealed {
	private Long id;
	...
	public InclinationDealed(Long id, Long originId, Integer sensorId, Double angleX, Double angleY, Double angleTotal, Double directAngle, Double angleInitTotal, Double directAngleInit, Double temperature, Date createTime, String version) {
		this.id = id;
