...
//		int BUFFER_SIZE = 4096;
	...
	public static boolean fileRename(String sourcePath, String targetPath){
		...
		boolean result = file.renameTo(new File(targetPath));
		return result;
	}
	...
	public static boolean folderRename(String sourcePath, String targetPath){
		...
		boolean result = file1.renameTo(new File(targetPath));
		return result;
	}

	public static void main(String[] args) {

//		String absolutePath = "C:\\Users\\curek\\IdeaProjects\\Renewable_Power\\terminal\\";
		String path = "audio\\";
		String fileName = "audio_433952";
		String targetFileName = "wstest";

		String fileExtension = ".wav";

		boolean result = false;
//		try {
//			copy(new File(path+fileName+fileExtension), new File(path+"tool\\"+targetFileName+fileExtension));
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
